...
# Generated by install.sh — source of truth lives in the release asset at
# https://github.com/secur8yai/xmedia/releases/latest
services:
  postgres:
